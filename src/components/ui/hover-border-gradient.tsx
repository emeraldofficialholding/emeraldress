...
>) {
  ...
  const movingMap: Record<Direction, string> = {
    TOP: "radial-gradient(20.7% 50% at 50% 0%, #059669 0%, rgba(255, 255, 255, 0) 100%)",
    LEFT: "radial-gradient(16.6% 43.1% at 0% 50%, #059669 0%, rgba(255, 255, 255, 0) 100%)",
    BOTTOM: "radial-gradient(20.7% 50% at 50% 100%, #059669 0%, rgba(255, 255, 255, 0) 100%)",
  ...
  return (
    ...
    >
      ...
      />
      <div className="bg-[#e4ffec] absolute z-1 flex-none inset-[2px] rounded-[100px]" />
    </Tag>
  );
}
