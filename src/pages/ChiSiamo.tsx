    ...
    content: (
      <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <img
            src="https://jtmbnmpggzbucmgglisw.supabase.co/storage/v1/object/public/emerald-asset/sfondo%20emerald%20scanner.PNG"
            alt="Costa Smeralda"
    ...
    <div className="container mx-auto px-4 lg:px-8">
      ...
      <motion.div {...fadeUp} className="max-w-2xl mb-20">
        ...
        <p className="text-muted-foreground font-sans leading-relaxed">
          Dalla Costa Smeralda al mondo. EMERALDRESS nasce dalla visione di unire l'artigianato sardo con l'innovazione
          tessile sostenibile, creando capi che rispettano la Terra senza compromessi sull'eleganza.
        </p>
      </motion.div>
    </div>
