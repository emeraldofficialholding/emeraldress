...
export default function ResetPassword() {
  ...
  // Detect Supabase recovery session: link arrives with #access_token & type=recovery,
  // the SDK auto-creates a session. We listen for PASSWORD_RECOVERY or existing session.
  useEffect(() => {
    let active = true;
    const init = async () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reset Password · Emeraldress</title>
